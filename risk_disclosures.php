    ...
    <section id="risk_disclosures" class="privacy_policy">
        <section class="first_section">
            <div class="container">
                ...
                <p>On an average, loss makers registered net trading loss close to ₹ 50,000.
                </p>
                <p>Over and above the net trading losses incurred, loss makers expended an additional 28%
                    of net trading losses as transaction costs. </p>
                <p>Those making net trading profits, incurred between 15% to 50% of such profits as
                    transaction cost.</p> -->
                <p>Source:</p>
                <p>
                    <a href="https://www.sebi.gov.in/reports-and-statistics/research/jan-2023/study-analysis-of-profit-and-loss-of-individual-traders-dealing-in-equity-fando-segment_67525.html"
                        target="_blank">
                        SEBI study dated January 25, 2023 on “Analysis of Profit and Loss of Individual Traders dealing
                        in
